...
ActiveRecord::Schema.define(version: 2021_10_20_090014) do
  ...
  create_table "blockchains", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "properties", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
    t.text "value"
    t.integer "token_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "token_ownerships", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "token_id"
