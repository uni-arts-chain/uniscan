...
ActiveRecord::Schema.define(version: 2021_10_20_090014) do
  ...
  create_table "accounts", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "address"
  ...
  create_table "active_storage_attachments", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "active_storage_blobs", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "active_storage_variant_records", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.bigint "blob_id", null: false
    t.string "variation_digest", null: false
    t.index ["blob_id", "variation_digest"], name: "index_active_storage_variant_records_uniqueness", unique: true
  end

  create_table "blockchains", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "collections", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name"
    t.string "symbol"
    t.integer "blockchain_id"
  ...
  create_table "properties", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.string "name"
    t.text "value"
    t.integer "token_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "token_ownerships", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.integer "token_id"
  ...
  create_table "tokens", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
  ...
  create_table "transfers", charset: "utf8mb4", collation: "utf8_general_ci", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "token_id"
